...
1. Спроектируйте to be архитектуру КиноБездны, разделив всю систему на отдельные домены и организовав интеграционное взаимодействие и единую точку вызова сервисов.
   ...
   [Диаграмма контейнеров To-Be микросервисной архитектуры](docs/diagrams/container/Container.puml)
...
1. Создайте Personal Access Token (PAT) [https://github.com/settings/tokens](https://github.com/settings/tokens) . Создавайте class с правом read:packages
...
1. Добавьте в секрет src/kubernetes/dockerconfigsecret.yaml в поле

```bash
 .dockerconfigjson: значение в base64 файла ~/.docker/config.json
```

1. Если в ~/.docker/config.json нет значения для аутентификации
...
1. Создайте секреты и переменные
...
1. В папке ./templates/services заполните шаблоны для proxy-service.yaml и events-service.yaml (опирайтесь на свою kubernetes конфигурацию - смысл helm'а сделать шаблоны для быстрого обновления и установки)
